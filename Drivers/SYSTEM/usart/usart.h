...
#define USART_U2                        USART2
#define USART_U2_IRQn                   USART2_IRQn
#define USART_U2_IRQHandler             USART2_IRQHandler
...
extern uint8_t g_uart2_rx_buffer[RXBUFFERSIZE];

extern uint8_t my_rx_buf[USART_REC_LEN]; // ??????????
extern uint16_t my_rx_index; 
