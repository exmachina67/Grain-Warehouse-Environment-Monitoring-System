...
#define ATK_MW1278D_TIM_INTERFACE               TIM7
#define ATK_MW1278D_TIM_IRQn                    TIM7_IRQn 
#define ATK_MW1278D_TIM_IRQHandler              TIM7_IRQHandler
#define ATK_MW1278D_TIM_CLK_ENABLE()            do{ __HAL_RCC_TIM7_CLK_ENABLE();}while(0)
...
void atk_mw1278d_uart_send_bin(uint8_t *buf, uint16_t len); /* ATK-MW1278D UART 发送二进制 */
