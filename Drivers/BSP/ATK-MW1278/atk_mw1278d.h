...
/* 引脚定义 */
#define ATK_MW1278D_AUX_GPIO_PORT           GPIOF
#define ATK_MW1278D_AUX_GPIO_PIN            GPIO_PIN_6
#define ATK_MW1278D_AUX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)
#define ATK_MW1278D_MD0_GPIO_PORT           GPIOC
...
uint8_t ATK_MW1278D_Init(void);                                                                              /* ATM-MW1278D模块初始化配置 */
